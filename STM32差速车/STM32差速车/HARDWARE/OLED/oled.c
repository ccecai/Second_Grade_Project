...
{
	OLED_ShowString(0,0,"BAT :",12);
	OLED_ShowString(90,0,"V",12);
	OLED_ShowString(0,1,"L:",12);
	OLED_ShowString(60,1,"R:",12);		
	OLED_ShowString(0,2,"SPD:",12);
	OLED_ShowString(60,2,"TURN:",12);
	OLED_ShowString(0,6,"MODE:",12);
}

void oled_show(void)
{
		OLED_Float(0,48,Voltage,2);						//ÏÔÊ¾µçÑ¹
		OLED_Num3(4,1,Encoder_Left);					//ÏÔÊ¾×ó±ßµç»úµÄ±àÂëÆ÷Öµ
		OLED_Num3(14,1,Encoder_Right);					//ÏÔÊ¾ÓÒ±ßµç»úµÄ±àÂëÆ÷Öµ
		
//		OLED_Num3(5,2,Velocity);					//ÏÔÊ¾ÓÒ±ßµç»úµÄ±àÂëÆ÷Öµ
//		OLED_Num3(16,2,Turn);					//ÏÔÊ¾×ó±ßµç»úµÄ±àÂëÆ÷Öµ
//		switch(CTRL_MODE)
//		{
//			case 97:
...
//				OLED_ShowString(10,5,"count:",12);
				OLED_Num4(10,5,count);	
//			break;
//			case 100:
...
//				OLED_Num3(4,4,PS2_LX);					//ÏÔÊ¾PS2Ò¡¸ËÊý¾Ý
