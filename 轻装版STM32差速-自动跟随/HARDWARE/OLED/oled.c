...
void oled_first_show(void)
{
	...
	OLED_ShowString(1,4,"DL: ",12);	
	OLED_ShowString(60,4,"DR: ",12);
	
	OLED_ShowString(1,6,"EL: ",12);	
	OLED_ShowString(60,6,"ER: ",12);
}
...
void oled_show(void)
{
		...
		OLED_Num4(4,4,distanceL);				
		OLED_Num4(14,4,distanceR);			
		OLED_Num2(4,6,Encoder_Left);					//ÏÔÊ¾ÓÒ±ßµç»úµÄ±àÂëÆ÷Öµ
		OLED_Num2(14,6,Encoder_Right);					//ÏÔÊ¾×ó±ßµç»úµÄ±àÂëÆ÷
